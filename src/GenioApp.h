...
{
	const BString kApplicationName(B_TRANSLATE_SYSTEM_NAME("Haikode"));
	const BString kApplicationSignature("application/x-vnd.Haikode");
	const BString kSettingsFileName("Haikode.settings");
